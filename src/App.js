...
class BooksApp extends React.Component {
    ...
    */
    ...
    render() {
        return ( <
            div className = "app" > { /*Here we are adding Routes to replace the state dependent page management */ } <
            Route path = "/search"
            render = {
                () => ( <
                    BookSearch
            ...
            render = {
                () => ( <
                    ...
                    <
                    div > { /* Filter to get the "currently reading" books from the state and pass as prop to the shelf */ } <
                    ...
                    /div> <
                    /div> <
                    div className = "open-search" > { /* Replace anchor with link that routes appropriately */ } <
